...
import { QOO10_SECTION_KEYS } from '@/lib/reports/section-keys'
    ...
    <Card>
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <CardTitle className="text-base">📊 월간 요약 (Qoo10)</CardTitle>
          {headerAction}
        </div>
      </CardHeader>
      <CardContent>
...
function WeeklyCharts({
  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <CardTitle className="text-base">📈 주별 차트 (Qoo10)</CardTitle>
          {headerAction}
        </div>
      </CardHeader>
      <CardContent>
...
function WeeklyTable({
  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <CardTitle className="text-base">🗓️ 주별 데이터 (Qoo10)</CardTitle>
          {headerAction}
        </div>
      </CardHeader>
      <CardContent>
...
function DailySection({
  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <CardTitle className="text-base">📅 일별 데이터 (Qoo10)</CardTitle>
          {headerAction}
        </div>
      </CardHeader>
      <CardContent>
...
function ProductSection({
  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <CardTitle className="text-base">🛒 제품별 성과 (Qoo10)</CardTitle>
          {headerAction}
        </div>
      </CardHeader>
      <CardContent>
...
export function Qoo10ReportDetail({
  data,
  title,
  reportId,
  role,
  ...
  return (
    <div className="space-y-10">
      ...
      <SectionInsightCard
        reportId={reportId}
        role={role}
        sectionKey={QOO10_SECTION_KEYS.monthly}
        defaultLabel="월간 요약 인사이트"
        initialEntry={sectionInsights[QOO10_SECTION_KEYS.monthly]}
      >
        {(addButton) => <MonthlyTable m={monthly} headerAction={addButton} />}
      </SectionInsightCard>
      ...
      {weekly.length > 0 && (
        <SectionInsightCard
          reportId={reportId}
          role={role}
          sectionKey={QOO10_SECTION_KEYS.weeklyTable}
          defaultLabel="주간 데이터 인사이트"
          initialEntry={sectionInsights[QOO10_SECTION_KEYS.weeklyTable]}
        >
          {(addButton) => <WeeklyTable weekly={weekly} headerAction={addButton} />}
        </SectionInsightCard>
      )}
      ...
      {weekly.length > 0 && (
        <SectionInsightCard
          reportId={reportId}
          role={role}
          sectionKey={QOO10_SECTION_KEYS.weeklyCharts}
          defaultLabel="주간 차트 인사이트"
          initialEntry={sectionInsights[QOO10_SECTION_KEYS.weeklyCharts]}
        >
          {(addButton) => <WeeklyCharts weekly={weekly} headerAction={addButton} />}
        </SectionInsightCard>
      )}
      ...
      {daily.length > 0 && (
        <SectionInsightCard
          reportId={reportId}
          role={role}
          sectionKey={QOO10_SECTION_KEYS.daily}
          defaultLabel="일별 데이터 인사이트"
          initialEntry={sectionInsights[QOO10_SECTION_KEYS.daily]}
        >
          {(addButton) => <DailySection daily={daily} headerAction={addButton} />}
        </SectionInsightCard>
      )}
      ...
      {products.length > 0 && (
        <SectionInsightCard
          reportId={reportId}
          role={role}
          sectionKey={QOO10_SECTION_KEYS.products}
          defaultLabel="제품별 성과 인사이트"
          initialEntry={sectionInsights[QOO10_SECTION_KEYS.products]}
        >
          {(addButton) => <ProductSection products={products} headerAction={addButton} />}
        </SectionInsightCard>
      )}
    </div>
  )
